...
Although, no guarantee is provided with it. The Users are always supposed to know what they're doing and how to manage and backup sensitive information.
...
Downloading the AnuBitux distro, the Users implicitly accepts to use it, considering themselves as responsible for the actions they will carry out and that the AnuBitux team is not responsible in any way for eventual malfunctions or misconfigured tools.
