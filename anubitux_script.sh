...
wget https://github.com/minios-linux/b43-firmware/releases/download/b43-firmware/no_net_install_bcm43xx_firmware.tar.bz2
tar -xvf no_net*
cd bcm43xx_firmware
./install_*
cd ..
...
sudo dpkg -i x86_64-linux-deb-piratewallet-lite*
